export const APP_VERSION = "MAP_ONLY_AWTEC_LIVEFARE_V6";

export const tripMeta = {
  title: "해상풍력 업무·북유럽 여행 대시보드 2026",
  subtitle: "Google Maps 업무장소만 방문 · 대만 약 3일 · AWTEC 2026 · 홍콩 당일 경유",
...
export const days = [
  { id:1, date:"2026-09-02", weekday:"수요일", cities:"코펜하겐 → 빌룬 → 에스비에르", lodging:"Boutique Hotel Britannia", summary:"SK988 직항 도착 · 지도 저장장소 Blue Water Shipping 1곳만 업무 방문 · LEGO House와 북해 해변 관광" },
  { id:2, date:"2026-09-03", weekday:"목요일", cities:"에스비에르 → 함부르크 → 로테르담", lodging:"Hotel New York Rotterdam", summary:"지도 저장장소 Skyborn Renewables 방문 · 함부르크 관광·Restaurant Leuchtturm 점심 · 렌터카로 로테르담 이동" },
  { id:3, date:"2026-09-04", weekday:"금요일", cities:"헤이그 → 델프트 → 로테르담", lodging:"Hotel New York Rotterdam", summary:"지도 저장장소 TNO·Stieltjesweg·로테르담항만 업무 방문 · 사이사이는 미술관·구시가지·건축 관광" },
  { id:4, date:"2026-09-05", weekday:"토요일", cities:"로테르담 → 암스테르담 → 오슬로", lodging:"Clarion Hotel The Hub", summary:"KLM 직항으로 오슬로 이동 · 오페라하우스·MUNCH·Sørenga 관광 · 노르웨이 업무일정 없음" },
  { id:5, date:"2026-09-06", weekday:"일요일", cities:"오슬로", lodging:"Clarion Hotel The Hub", summary:"비겔란·뷔그되이·프람호·오슬로피오르 순수 관광과 현지 식당" },
...
export const events = [
  e("d1-01",1,"9/1 23:35","9/2 06:00","SK988 인천(ICN) → 코펜하겐(CPH) 직항","항공","ICN → CPH","SAS","13시간 25분",{booking_url:"https://www.google.com/travel/flights",notes:"2026-07-23 Google Flights 검색 기준 운항시각. 실시간 총액은 항공·숙박 탭에서 자동 갱신."}),
  e("d1-02",1,"06:50","07:30","7인승 렌터카 인수·출발","교통","Copenhagen Airport","렌터카","40분",{notes:"4인+수하물. 덴마크→독일→네덜란드 편도반납·국경통과·완전자차를 반드시 포함."}),
  e("d1-03",1,"07:30","10:15","코펜하겐공항 → Blue Water Shipping","교통","CPH → Billund","렌터카","약 2시간 45분"),
  e("d1-04",1,"10:30","12:00","Blue Water Shipping 방문","업무","지도 저장 좌표 55.7358995, 9.1513797","렌터카","90분",{official_url:"https://www.bws.net/",map_url:"https://www.google.com/maps/search/?api=1&query=55.7358995,9.1513797",notes:"공유 Google Maps에 있는 지점. 풍력부품 운송·보관·통관·설치지연 대응만 질의."}),
  e("d1-05",1,"12:15","15:00","LEGO House 관람·Mini Chef 점심","관광·식사","Billund","렌터카+도보","2시간 45분",{booking_url:"https://legohouse.com/en-gb/"}),
  e("d1-06",1,"15:00","16:10","빌룬 → 에스비에르","교통","Billund → Esbjerg","렌터카","약 1시간 10분"),
  e("d1-07",1,"16:30","18:00","Men at Sea·Sædding 해변 산책","관광","Esbjerg","렌터카+도보","90분",{map_url:"https://www.google.com/maps/search/?api=1&query=Men+at+Sea+Esbjerg"}),
  e("d1-08",1,"19:00","20:30","Restaurant Mundheld 저녁","식사","Hotel Britannia, Esbjerg","도보","90분",{booking_url:"https://www.britannia.dk/en"}),

  e("d2-01",2,"06:45","09:40","에스비에르 → 함부르크","교통","Esbjerg → Hamburg","렌터카","약 2시간 55분"),
  e("d2-02",2,"10:00","11:30","Skyborn Renewables 방문","업무","Ericusspitze 2, Hamburg","렌터카","90분",{official_url:"https://www.skybornrenewables.com/",map_url:"https://www.google.com/maps/search/?api=1&query=Skyborn+Renewables+Ericusspitze+2",notes:"공유 Google Maps에 있는 지점. 개발·인허가·계통·수익성·계약관리 질의."}),
  e("d2-03",2,"11:35","12:15","Speicherstadt·Elbphilharmonie 외관","관광","Hamburg HafenCity","도보","40분",{map_url:"https://www.google.com/maps/search/?api=1&query=Elbphilharmonie+Hamburg"}),
  e("d2-04",2,"12:30","13:30","Restaurant Leuchtturm 점심","식사","Außenmühlendamm 2, Hamburg-Harburg","렌터카","60분",{booking_url:"https://www.leuchtturm-harburg.de/",notes:"공유 Google Maps 저장 식당. 월–토 12:30부터 영업 확인."}),
  e("d2-05",2,"13:30","19:00","함부르크 → 로테르담","교통","Hamburg-Harburg → Rotterdam","렌터카","약 5시간 30분",{notes:"교대운전자 2명·휴게 1회. 항공은 4인 기준 당일 조회가 렌터카보다 현저히 비싸 렌터카 유지."}),
  e("d2-06",2,"19:30","21:00","Fenix·Katendrecht 산책과 저녁","관광·식사","Rotterdam","도보","90분",{booking_url:"https://fenix.nl/en/food-at-fenix/"}),

  e("d3-01",3,"08:30","10:00","TNO 방문","업무","Oude Waalsdorperweg 63, Den Haag","렌터카","90분",{official_url:"https://www.tno.nl/en/about-tno/contact/",map_url:"https://www.google.com/maps/search/?api=1&query=TNO+Oude+Waalsdorperweg+63",notes:"공유 Google Maps에 있는 TNO 지점만 방문."}),
  e("d3-02",3,"10:10","11:10","Mauritshuis·Hofvijver","관광","Den Haag","렌터카+도보","60분",{booking_url:"https://www.mauritshuis.nl/en/"}),
  e("d3-03",3,"11:35","12:05","Stieltjesweg 1 저장장소 확인","업무","Stieltjesweg 1, Delft","렌터카","30분",{map_url:"https://www.google.com/maps/search/?api=1&query=Stieltjesweg+1+Delft",notes:"공유 Google Maps에 저장된 정확한 주소. 기관명·면담 여부는 사전 확인 후 확정."}),
  e("d3-04",3,"12:15","13:40","Delft Markt·Stads-Koffyhuis 점심","관광·식사","Delft","도보","85분",{booking_url:"https://www.stads-koffyhuis.nl/"}),
  e("d3-05",3,"14:30","16:00","로테르담항 방문","업무","지도 저장 좌표 51.9496008, 4.145263","렌터카","90분",{official_url:"https://www.portofrotterdam.com/en",map_url:"https://www.google.com/maps/search/?api=1&query=51.9496008,4.145263",notes:"공유 Google Maps의 로테르담항 지점. 중량물·항만임대·탈탄소·위험분담 질의."}),
  e("d3-06",3,"16:30","19:00","Markthal·Cube Houses·Oude Haven","관광","Rotterdam Centrum","도보","2시간 30분",{map_url:"https://www.google.com/maps/search/?api=1&query=Markthal+Rotterdam"}),
  e("d3-07",3,"19:00","20:30","Old Scuola Rotterdam 저녁","식사","Rotterdam","도보/택시","90분",{booking_url:"https://oldscuola.nl/"}),

  e("d4-01",4,"06:50","07:45","로테르담 → 스키폴·렌터카 반납","교통","Rotterdam → AMS","렌터카","55분"),
  e("d4-02",4,"09:20","11:05","AMS → OSL 직항","항공","Amsterdam → Oslo","KLM","1시간 45분",{booking_url:"https://www.google.com/travel/flights",notes:"최저가 편은 오후일 수 있으나 오슬로 관광시간을 위해 오전편 권고. 양쪽 가격을 항공 탭에 표시."}),
  e("d4-03",4,"12:00","13:00","공항철도 → Oslo S·호텔 짐보관","교통","OSL → Oslo S","Flytoget","약 1시간",{booking_url:"https://flytoget.no/en/"}),
  e("d4-04",4,"13:30","17:30","오슬로 오페라하우스·MUNCH·Sørenga","관광","Bjørvika, Oslo","도보","4시간",{booking_url:"https://www.munch.no/en/",notes:"노르웨이에는 업무 방문을 배치하지 않음."}),
  e("d4-05",4,"18:00","19:30","Fiskeriet Youngstorget 저녁","식사","Oslo","도보","90분",{booking_url:"https://fiskeriet.com/"}),

  e("d5-01",5,"09:00","11:00","비겔란 조각공원","관광","Frogner, Oslo","트램+도보","2시간",{map_url:"https://www.google.com/maps/search/?api=1&query=Vigeland+Park+Oslo"}),
  e("d5-02",5,"11:30","15:00","Bygdøy·Fram Museum·점심","관광·식사","Bygdøy, Oslo","버스/페리","3시간 30분",{booking_url:"https://frammuseum.no/"}),
  e("d5-03",5,"15:30","17:30","오슬로피오르 미니크루즈","관광","Rådhusbrygge","유람선","2시간",{booking_url:"https://www.visitoslo.com/en/product/?tlp=2984443&name=Fjord-Sightseeing"}),
  e("d5-04",5,"18:00","19:30","Lofoten Fiskerestaurant 저녁","식사","Aker Brygge","도보","90분",{booking_url:"https://lofoten-fiskerestaurant.no/"}),
...
export const flights = [
  { id:"f1",day_id:1,date:"2026-09-01",flight_no:"SK988",origin:"ICN",destination:"CPH",depart_time:"23:35",arrive_time:"06:00+1",min_krw:null,max_krw:null,status:"직항·자동가격",alternative:"9/2 출발 시 업무시간 감소",url:"https://www.flysas.com/",notes:"4인 일반석·직항 최저가 자동조회",sort_order:10 },
  { id:"f2",day_id:4,date:"2026-09-05",flight_no:"KLM 직항",origin:"AMS",destination:"OSL",depart_time:"09:20 권고",arrive_time:"11:05",min_krw:null,max_krw:null,status:"오전편 권고",alternative:"노선 최저가는 오후편 가능",url:"https://www.klm.com/",notes:"최저가와 일정 채택가를 분리 표시",sort_order:20 },
...
export const hotels = [
  { id:"h1",day_id:1,name:"Boutique Hotel Britannia",city:"Esbjerg",check_in:"2026-09-02",check_out:"2026-09-03",nights:1,rooms:2,min_krw:350000,max_krw:550000,status:"추천",alternative:"A Place To Hotel Esbjerg",url:"https://www.britannia.dk/en",notes:"식당·도심 접근",sort_order:10 },
  { id:"h2",day_id:2,name:"Hotel New York Rotterdam",city:"Rotterdam",check_in:"2026-09-03",check_out:"2026-09-05",nights:2,rooms:2,min_krw:850000,max_krw:1300000,status:"추천",alternative:"Room Mate Bruno",url:"https://hotelnewyork.com/",notes:"Katendrecht·항만 분위기",sort_order:20 },
  { id:"h3",day_id:4,name:"Clarion Hotel The Hub",city:"Oslo",check_in:"2026-09-05",check_out:"2026-09-07",nights:2,rooms:2,min_krw:800000,max_krw:1200000,status:"추천",alternative:"Thon Hotel Opera",url:"https://www.strawberryhotels.com/hotels/norway/oslo/clarion-hotel-the-hub/",notes:"Oslo S·공항철도 접근",sort_order:30 },
...
export const meetings = [
  { id:"m1",day_id:1,organization:"Blue Water Shipping",agenda:"풍력부품 운송·보관·통관·설치지연 대응",recommended_duration:"90분",contact:"",status:"요청",photo_allowed:false,ppe_required:false,interpreter_needed:false,url:"https://www.bws.net/",notes:"Google Maps 저장 좌표 지점",sort_order:10 },
  { id:"m2",day_id:2,organization:"Skyborn Renewables",agenda:"개발·인허가·계통·수익성·계약관리",recommended_duration:"90분",contact:"",status:"요청",photo_allowed:false,ppe_required:false,interpreter_needed:false,url:"https://www.skybornrenewables.com/",notes:"Google Maps 저장 지점",sort_order:20 },
  { id:"m3",day_id:3,organization:"TNO",agenda:"해상풍력 시험·연구·인증 협력",recommended_duration:"90분",contact:"",status:"요청",photo_allowed:false,ppe_required:false,interpreter_needed:false,url:"https://www.tno.nl/en/about-tno/contact/",notes:"Oude Waalsdorperweg 63",sort_order:30 },
  { id:"m4",day_id:3,organization:"Stieltjesweg 1 저장장소",agenda:"기관명·면담 가능 여부 사전 확인",recommended_duration:"30분",contact:"",status:"확인 필요",photo_allowed:false,ppe_required:false,interpreter_needed:false,url:"https://www.google.com/maps/search/?api=1&query=Stieltjesweg+1+Delft",notes:"지도에는 주소명으로만 저장됨",sort_order:40 },
  { id:"m5",day_id:3,organization:"로테르담항",agenda:"중량물·항만임대·탈탄소·투자·위험분담",recommended_duration:"90분",contact:"",status:"요청",photo_allowed:true,ppe_required:true,interpreter_needed:false,url:"https://www.portofrotterdam.com/en",notes:"Google Maps 저장 좌표 지점",sort_order:50 },
...
export const transportOptions = [
  ...
  { id:"t3",region:"오슬로",recommendation:"Flytoget+대중교통",reason:"업무장소 없음·도심 주차 불필요",min_krw:350000,max_krw:550000,notes:"4인 2일",sort_order:30 },
...
export const restaurants = [
  { id:"r1",day_id:1,name:"Mini Chef at LEGO House",city:"Billund",meal_type:"점심",price_per_person:"DKK 199~299",url:"https://legohouse.com/en-gb/explore/eateries/mini-chef/",notes:"체험형·예약 권고",sort_order:10 },
  { id:"r2",day_id:1,name:"Restaurant Mundheld",city:"Esbjerg",meal_type:"저녁",price_per_person:"DKK 400~700",url:"https://www.britannia.dk/en",notes:"호텔 내",sort_order:20 },
  { id:"r3",day_id:2,name:"Restaurant Leuchtturm",city:"Hamburg-Harburg",meal_type:"점심",price_per_person:"EUR 30~60",url:"https://www.leuchtturm-harburg.de/",notes:"공유 Google Maps 저장 식당",sort_order:30 },
  { id:"r4",day_id:2,name:"O Anatolian Café at Fenix",city:"Rotterdam",meal_type:"저녁",price_per_person:"EUR 20~35",url:"https://fenix.nl/en/food-at-fenix/",notes:"Katendrecht",sort_order:40 },
  { id:"r5",day_id:3,name:"Stads-Koffyhuis",city:"Delft",meal_type:"점심",price_per_person:"EUR 18~30",url:"https://www.stads-koffyhuis.nl/",notes:"구시가지",sort_order:50 },
  { id:"r6",day_id:4,name:"Fiskeriet Youngstorget",city:"Oslo",meal_type:"저녁",price_per_person:"NOK 300~550",url:"https://fiskeriet.com/",notes:"해산물",sort_order:60 },
  { id:"r7",day_id:5,name:"Lofoten Fiskerestaurant",city:"Oslo",meal_type:"저녁",price_per_person:"NOK 550~950",url:"https://lofoten-fiskerestaurant.no/",notes:"Aker Brygge",sort_order:70 },
...
export const mapPoints = [
  {id:"p01",day_id:1,name:"인천공항",lat:37.458666,lng:126.4419679,sort_order:1,segment_type:"flight",popup:"9/1 23:35 SK988",url:""},
  {id:"p02",day_id:1,name:"코펜하겐공항",lat:55.6181,lng:12.6560,sort_order:2,segment_type:"flight",popup:"9/2 06:00 도착",url:""},
  {id:"p03",day_id:1,name:"Blue Water Shipping",lat:55.7358995,lng:9.1513797,sort_order:3,segment_type:"car",popup:"지도 허용 업무장소",url:"https://www.bws.net/"},
  {id:"p04",day_id:1,name:"LEGO House",lat:55.7308,lng:9.1153,sort_order:4,segment_type:"car",popup:"관광·점심",url:"https://legohouse.com/"},
  {id:"p05",day_id:1,name:"Men at Sea",lat:55.4894,lng:8.4123,sort_order:5,segment_type:"car",popup:"관광",url:""},
  {id:"p06",day_id:1,name:"Hotel Britannia",lat:55.4672,lng:8.4511,sort_order:6,segment_type:"car",popup:"숙박·저녁",url:"https://www.britannia.dk/en"},

  {id:"p07",day_id:2,name:"Esbjerg 출발",lat:55.4672,lng:8.4511,sort_order:1,segment_type:"car",popup:"06:45 출발",url:""},
  {id:"p08",day_id:2,name:"Skyborn Renewables",lat:53.5454495,lng:10.0032102,sort_order:2,segment_type:"car",popup:"지도 허용 업무장소",url:"https://www.skybornrenewables.com/"},
  {id:"p09",day_id:2,name:"Speicherstadt",lat:53.5439,lng:9.9950,sort_order:3,segment_type:"car",popup:"관광",url:""},
  {id:"p10",day_id:2,name:"Restaurant Leuchtturm",lat:53.450779,lng:9.9810776,sort_order:4,segment_type:"car",popup:"지도 저장 식당",url:"https://www.leuchtturm-harburg.de/"},
  {id:"p11",day_id:2,name:"Hotel New York Rotterdam",lat:51.9048,lng:4.4844,sort_order:5,segment_type:"car",popup:"숙박·Fenix",url:"https://hotelnewyork.com/"},

  {id:"p12",day_id:3,name:"Hotel New York 출발",lat:51.9048,lng:4.4844,sort_order:1,segment_type:"car",popup:"출발",url:""},
  {id:"p13",day_id:3,name:"TNO Den Haag",lat:52.109418,lng:4.3273737,sort_order:2,segment_type:"car",popup:"지도 허용 업무장소",url:"https://www.tno.nl/en/"},
  {id:"p14",day_id:3,name:"Mauritshuis",lat:52.0800,lng:4.3143,sort_order:3,segment_type:"car",popup:"관광",url:"https://www.mauritshuis.nl/en/"},
  {id:"p15",day_id:3,name:"Stieltjesweg 1",lat:52.0007524,lng:4.3767328,sort_order:4,segment_type:"car",popup:"지도 허용 주소",url:""},
  {id:"p16",day_id:3,name:"Delft Markt",lat:52.0116,lng:4.3571,sort_order:5,segment_type:"car",popup:"관광·점심",url:""},
  {id:"p17",day_id:3,name:"로테르담항",lat:51.9496008,lng:4.145263,sort_order:6,segment_type:"car",popup:"지도 허용 업무장소",url:"https://www.portofrotterdam.com/en"},
  {id:"p18",day_id:3,name:"Markthal Rotterdam",lat:51.9201,lng:4.4869,sort_order:7,segment_type:"car",popup:"관광·저녁",url:""},

  {id:"p19",day_id:4,name:"Rotterdam",lat:51.9244,lng:4.4695,sort_order:1,segment_type:"car",popup:"출발",url:""},
  {id:"p20",day_id:4,name:"Schiphol Airport",lat:52.3127866,lng:4.7401699,sort_order:2,segment_type:"car",popup:"09:20 출발",url:""},
  {id:"p21",day_id:4,name:"Oslo Airport",lat:60.1939,lng:11.1004,sort_order:3,segment_type:"flight",popup:"11:05 도착",url:""},
  {id:"p22",day_id:4,name:"Oslo Opera House",lat:59.9075,lng:10.7530,sort_order:4,segment_type:"subway",popup:"관광",url:""},
  {id:"p23",day_id:4,name:"MUNCH",lat:59.9064,lng:10.7550,sort_order:5,segment_type:"subway",popup:"관광",url:"https://www.munch.no/en/"},
  {id:"p24",day_id:4,name:"Clarion Hotel The Hub",lat:59.9128,lng:10.7502,sort_order:6,segment_type:"subway",popup:"숙박",url:""},

  {id:"p25",day_id:5,name:"Vigeland Park",lat:59.9272,lng:10.7000,sort_order:1,segment_type:"subway",popup:"관광",url:""},
  {id:"p26",day_id:5,name:"Fram Museum",lat:59.9028,lng:10.6990,sort_order:2,segment_type:"subway",popup:"관광",url:"https://frammuseum.no/"},
  {id:"p27",day_id:5,name:"Rådhusbrygge Fjord Cruise",lat:59.9105,lng:10.7290,sort_order:3,segment_type:"subway",popup:"피오르드 관광",url:""},
  {id:"p28",day_id:5,name:"Aker Brygge",lat:59.9109,lng:10.7276,sort_order:4,segment_type:"subway",popup:"저녁",url:""},
...
export const budgetItems = [
  ...
  { id:"b2",category:"숙박",label:"호텔 8박·2실",min_krw:4000000,max_krw:6100000,notes:"Esbjerg 1, Rotterdam 2, Oslo 2, Kaohsiung 2, Taichung 1",sort_order:20 },
