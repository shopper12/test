...
function weatherCodeLabel(code){const c=Number(code);if(c===0)return"맑음";if([1,2].includes(c))return"대체로 맑음";if(c===3)return"흐림";if([45,48].includes(c))return"안개";if(c>=51&&c<=67)return"비";if(c>=71&&c<=77)return"눈";if(c>=80&&c<=82)return"소나기";if(c>=95)return"뇌우 가능";return"변동 가능";}
function weatherImpact(m){
