...
export const PRACTICAL_DAYS = [
  ...
  {
    day:4, date:"9/5", city:"암스테르담 · 15:30 LIVE",
    plan:[
      ["지금~16:00","16:00 렘브란트 하우스권 확인 → 즉시 출발","비혼잡권 €19.50 · 잔여석 없으면 현장/산책 대안"],
      ["16:00~17:15","Museum Rembrandthuis","한국어 멀티미디어 가이드 포함 · 핵심 관람"],
      ["17:15~17:45","Black Gold 커피","18:00 마감 · 미술관에서 바로 이동"],
      ["17:45~18:30","Zuiderkerk·Amstel·Rembrandtplein 산책","공식 렘브란트 코스의 핵심만 압축"],
      ["18:30~19:45","Proeflokaal A. van Wees 저녁","전통 네덜란드식 · 만석이면 Café de Sluyswacht"],
      ["20:00~21:15","야간 운하 크루즈","실시간 잔여편·정확한 선착장 확인"],
      ["21:15~22:00","Jordaan·Dam·Centraal 야경","크루즈 도착지·피로에 따라 축소"],
      ["22:00 이후","Centraal → Sloterdijk → 호텔","NS/도보 · 체크인"]
    ]
  },
  {
...
export const RESTAURANTS = [
  ...
  {day:"4",city:"암스테르담",name:"Black Gold",fit:"렘브란트 하우스 관람 직후 커피 · 18시 마감 전 방문",menu:"스페셜티 espresso·filter coffee·cold brew",hours:"토·일 10:00~18:00",reserve:"예약 불필요",url:"https://europeancoffeetrip.com/cafe/Blackgoldamsterdam-amsterdam/",map:"https://www.google.com/maps/search/?api=1&query=Black+Gold+Amsterdam"},
...
export const ATTRACTIONS = [
  ...
  {day:"4",city:"암스테르담",name:"Museum Rembrandthuis",slot:"16:00~17:15",why:"렘브란트가 살고 작업한 실제 집·공방 · 한국어 멀티미디어 가이드 포함",hours:"매일 10:00~18:00",ticket:"성인 €23.50 · 16:00~18:00 €19.50 · 시간대 예약 권장",url:"https://tickets.rembrandthuis.nl/en/tickets",map:"https://www.google.com/maps/search/?api=1&query=Museum+Rembrandthuis+Amsterdam"},
  {day:"4",city:"암스테르담",name:"Rembrandt in Amsterdam Walk",slot:"17:45~18:30 압축",why:"공식 코스 중 Zuiderkerk·Amstel·Rembrandtplein 핵심만 저녁 동선으로 연결",hours:"옥외 상시",ticket:"무료 · 공식 도보 코스",url:"https://www.rembrandthuis.nl/en/whats-on/rembrandt-in-amsterdam/",map:"https://www.google.com/maps/dir/?api=1&origin=Museum+Rembrandthuis+Amsterdam&destination=Westerkerk+Amsterdam&waypoints=Zuiderkerk+Amsterdam%7CRembrandtplein+Amsterdam%7CBegijnhof+Amsterdam&travelmode=walking"},
  {day:"4",city:"암스테르담",name:"Amsterdam Canal Cruise",slot:"20:00~21:15",why:"저녁 뒤 야간 운하에서 도심과 17세기 운하 벨트를 한 번에 파악",hours:"운영사별",ticket:"20시 전후 잔여편 우선 · 정확한 출발지·시간 확인",url:"https://www.iamsterdam.com/en/tickets/canal-cruise-ticket",map:"https://www.google.com/maps/search/?api=1&query=Canal+Cruise+near+Anne+Frank+House+Amsterdam"},
