...
const MAP_MANIFEST = Object.freeze({
  ...
  "d1-03": {kind:"route",origin:"Taichung International Airport",destination:"CHECK Inn Taichung LaiLai, No.125 Sec. 3 Sanmin Rd., North Dist., Taichung",mode:"driving"},
  "d1-04": {kind:"place",query:"Taichung Park, Taichung, Taiwan"},
  "d1-05": {kind:"route",origin:"CHECK Inn Taichung LaiLai, No.125 Sec. 3 Sanmin Rd., North Dist., Taichung",destination:"Port of Taichung, Taiwan International Ports Corporation",mode:"driving"},
  ...
  "d1-08": {kind:"route",origin:"Gaomei Wetlands",destination:"CHECK Inn Taichung LaiLai, No.125 Sec. 3 Sanmin Rd., North Dist., Taichung",mode:"driving"},

  "d2-01": {kind:"route",origin:"CHECK Inn Taichung LaiLai, No.125 Sec. 3 Sanmin Rd., North Dist., Taichung",destination:"24.0765986,120.3773545",mode:"driving"},
  ...
  "d2-05": {kind:"route",origin:"Lukang Longshan Temple, Changhua, Taiwan",destination:"CHECK Inn Taichung LaiLai, No.125 Sec. 3 Sanmin Rd., North Dist., Taichung",mode:"driving"},
  "d2-06": {kind:"place",query:"Chun Shui Tang Siwei Original Store, Taichung"},

  "d3-00": {kind:"place",query:"CHECK Inn Taichung LaiLai, No.125 Sec. 3 Sanmin Rd., North Dist., Taichung"},
  ...
  "d3-02": {kind:"route",origin:"Calligraphy Greenway, Taichung",waypoints:"Miyahara, Taichung",destination:"CHECK Inn Taichung LaiLai, No.125 Sec. 3 Sanmin Rd., North Dist., Taichung",mode:"driving"},
  "d3-03": {kind:"route",origin:"CHECK Inn Taichung LaiLai, No.125 Sec. 3 Sanmin Rd., North Dist., Taichung",waypoints:"THSR Taichung Station|THSR Taoyuan Station",destination:"Taoyuan International Airport",mode:"transit"},
  ...
  "d4-02": {kind:"route",origin:"Rotterdam Centraal",destination:"PREMIER SUITES Rotterdam, Weena 710, 3014 DA Rotterdam",mode:"walking"},
  "d4-03": {kind:"route",origin:"PREMIER SUITES Rotterdam, Weena 710, 3014 DA Rotterdam",waypoints:"Markthal Rotterdam|Cube Houses Rotterdam",destination:"Oude Haven Rotterdam",mode:"walking"},
  "d4-04": {kind:"place",query:"PREMIER SUITES Rotterdam, Weena 710, 3014 DA Rotterdam"},
  "d4-05": {kind:"route",origin:"PREMIER SUITES Rotterdam, Weena 710, 3014 DA Rotterdam",waypoints:"Historic Delfshaven Rotterdam|Erasmus Bridge Rotterdam",destination:"Restaurant Bazar Rotterdam",mode:"transit"},

  "d5-01": {kind:"place",query:"PREMIER SUITES Rotterdam, Weena 710, 3014 DA Rotterdam"},
  "d5-02": {kind:"place",query:"PREMIER SUITES Rotterdam, Weena 710, 3014 DA Rotterdam"},
  "d5-03": {kind:"route",origin:"PREMIER SUITES Rotterdam, Weena 710, 3014 DA Rotterdam",waypoints:"Erasmusbrug Waterbus Rotterdam",destination:"Kinderdijk Windmills",mode:"transit"},
  "d5-04": {kind:"route",origin:"Kinderdijk Windmills",destination:"Fenix Food Factory Rotterdam",mode:"transit"},

  "d6-01": {kind:"place",query:"PREMIER SUITES Rotterdam, Weena 710, 3014 DA Rotterdam"},
  "d6-02": {kind:"route",origin:"PREMIER SUITES Rotterdam, Weena 710, 3014 DA Rotterdam",destination:"Port of Rotterdam Authority, Wilhelminakade 909, Rotterdam",mode:"driving"},
  ...
  "d6-08": {kind:"route",origin:"TNO Kesslerpark 1, Rijswijk",waypoints:"PREMIER SUITES Rotterdam, Weena 710, 3014 DA Rotterdam",destination:"Rotterdam Centraal",mode:"driving"},
  ...
  "d7-03": {kind:"place",query:"Hamburg, Germany"},
  "d7-04": {kind:"place",query:"Skyborn Renewables, Ericusspitze 2-4, Hamburg"},
  "d7-05": {kind:"place",query:"Skyborn Renewables, Ericusspitze 2-4, Hamburg"},
  "d7-055": {kind:"route",origin:"Skyborn Renewables, Ericusspitze 2-4, Hamburg",destination:"Best Western Plus Hotel St. Raphael, Adenauerallee 41, Hamburg",mode:"transit"},
  "d7-06": {kind:"place",query:"Best Western Plus Hotel St. Raphael, Adenauerallee 41, Hamburg"},
  "d7-07": {kind:"route",origin:"Best Western Plus Hotel St. Raphael, Adenauerallee 41, Hamburg",waypoints:"Elbphilharmonie Hamburg",destination:"Landungsbrücken Hamburg",mode:"transit"},

  "d8-01": {kind:"place",query:"Best Western Plus Hotel St. Raphael, Adenauerallee 41, Hamburg"},
  "d8-011": {kind:"route",origin:"Best Western Plus Hotel St. Raphael, Adenauerallee 41, Hamburg",destination:"DNV, Brooktorkai 18, 20457 Hamburg",mode:"driving"},
  "d8-012": {kind:"place",query:"DNV, Brooktorkai 18, 20457 Hamburg"},
  "d8-013": {kind:"route",origin:"DNV, Brooktorkai 18, 20457 Hamburg",waypoints:"Best Western Plus Hotel St. Raphael, Adenauerallee 41, Hamburg",destination:"Hamburg Hbf",mode:"driving"},
  ...
  "d9-01": {kind:"place",query:"CABINN Plus Esbjerg, Torvegade 27, 6700 Esbjerg"},
