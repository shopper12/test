...
ROUTES = [
    ...
    {
        "id": "route_f3",
        "label": "비용 최적 · 코펜하겐 → 파리 → 인천",
        "date": "2026-09-11",
        "origin": "CPH",
        "destination": "ICN",
        "max_stops": 1,
        "preferred_departure": "10:10",
        "preferred_arrival": "09:35",
        "via": ["CDG"],
        "reason": "9/11 귀국편 중 현재 4인 총액이 가장 낮은 1회 경유편",
    },
    {
        "id": "compare_rmq_ams",
    ...
    },
    {
        ...
        "via": ["IST"],
        "reason": "비용 최저안보다 약 1시간 빠른 인천 도착 비교",
    },
    {
